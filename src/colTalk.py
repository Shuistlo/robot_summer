...
#change to subscribe to image topic see ros_image_saver.py
#and replace all args
...
'''
	...
	while not rospy.is_shutdown():
		...
		if len(cnts) > 0:
			...
			M = cv2.moments(c) #this is the centre of the object
	...
	rospy.spin()
    #this also needs to publish data
